...
import { Eye, Droplet, Dumbbell, Wifi, Clock, Users, ArrowRight, Check, Printer, FileText, CreditCard, BookOpen, Package } from 'lucide-react';
...
const printingServices = [
  { 
    ...
    description: 'Чёрно-белая и цветная печать любых форматов',
    ...
    prices: [
      { name: 'А4 ч/б', price: '5₽' },
      { name: 'А4 цвет', price: '15₽' },
      { name: 'А3 ч/б', price: '10₽' },
      { name: 'А3 цвет', price: '30₽' },
    ],
    color: 'from-blue-500 to-cyan-500',
  },
  {
    ...
    prices: [
      { name: '50 шт.', price: '250₽' },
      { name: '100 шт.', price: '400₽' },
      { name: '200 шт.', price: '700₽' },
      { name: '500 шт.', price: '1500₽' },
    ],
    color: 'from-purple-500 to-pink-500',
  },
  {
    ...
    prices: [
      { name: 'А4 глянец', price: '50₽' },
      { name: 'А5 глянец', price: '35₽' },
      { name: 'Евро буклет', price: '40₽' },
      { name: 'Каталог 20 стр.', price: '500₽' },
    ],
    color: 'from-green-500 to-emerald-500',
  },
  {
    ...
    prices: [
      { name: 'А2 плакат', price: '200₽' },
      { name: 'А1 плакат', price: '400₽' },
      { name: 'А0 плакат', price: '800₽' },
      { name: 'Баннер 1м²', price: '500₽' },
    ],
    color: 'from-orange-500 to-red-500',
  },
  {
    ...
    description: 'Твёрдый и мягкий переплёт документов',
    ...
    prices: [
      ...
      { name: 'Термоклей', price: '150₽' },
      { name: 'Твёрдый переплёт', price: '500₽' },
    ],
